...
public class HIST extends JFrame implements ActionListener {
    ...
    public HIST(){
        ...
        search.setBounds(780, 175, 100, 20);

        txtf = new JTextField();
        txtf.setBounds(600, 175, 160, 20);
        ...
        DefaultTableModel model2 = new DefaultTableModel (new String[]{"TYPE OF DOCUMENT","PUSPOSE"}, 40);

      
       JTable table2 = new JTable(model2);
       JScrollPane scroll2 = new JScrollPane(table2);
       this.add (scroll2);
       scroll2.setBounds(182,280,700,350);
